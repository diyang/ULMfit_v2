    ...
    for i in range(batch_size):
        ...
        if(sum(true_label)==0){
            for j in range(num_labels):
                if (true_label[j] == predicted_label[j]) and true_label[i] == 0:
                    common_bits += 1.0
            accuracy_score += common_bits/(sum((true_label+predicted_label)<2))
        }else{
            for j in range(num_labels):
                if (true_label[j] == predicted_label[j]) and true_label[i] > 0:
                    common_bits += 1.0
    ...
    for i in range(batch_size):
        ...
        if(sum(predicted_label)==0){
            for j in range(num_labels):
                if (true_label[j] == predicted_label[j]) and true_label[i] == 0:
                    common_bits += 1.0
            accuracy_score += common_bits/(sum(predicted_label==0))
        }else{
            for j in range(num_labels):
                if (true_label[j] == predicted_label[j]) and true_label[i] > 0:
                    common_bits += 1.0
    ...
    for i in range(batch_size):
        ...
        if(sum(true_label)==0){
            for j in range(num_labels):
                if (true_label[j] == predicted_label[j]) and true_label[i] == 0:
                    common_bits += 1.0
            accuracy_score += common_bits/(sum(true_labels==0))
        }else{
            for j in range(num_labels):
                if (true_label[j] == predicted_label[j]) and true_label[i] > 0:
                    common_bits += 1.0
